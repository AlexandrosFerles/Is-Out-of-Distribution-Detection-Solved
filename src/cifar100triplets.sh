...
python ood_triplets.py --m generalizedodin --mc /raid/ferles/checkpoints/eb0/cifar100/genOdinCifar100.pth --nc 100  --nc 100 --in cifar100  --val cifar10  --dv 5 > results/genodin_cifar100val_cifar10.txt
...
python ood_triplets.py --m generalizedodin --mc /raid/ferles/checkpoints/eb0/cifar10/genOdinCifar10.pth --nc 100 --in cifar100 --val svhn  --dv 5 > results/genodin_cifar100val_svhn.txt
...
python ood_triplets.py --m generalizedodin --mc /raid/ferles/checkpoints/eb0/cifar10/genOdinCifar10.pth --nc 100 --in cifar100 --val stl  --dv 5 > results/genodin_cifar100val_stl.txt
...
python ood_triplets.py --m generalizedodin --mc /raid/ferles/checkpoints/eb0/cifar10/genOdinCifar10.pth --nc 100 --in cifar100 --val tinyimagenet  --dv 5 > results/genodin_cifar100val_tinyimagenet.txt