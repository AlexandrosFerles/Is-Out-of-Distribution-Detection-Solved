...
python ood.py --m rotation --mc /raid/ferles/checkpoints/isic_classifiers/rot_isic-best-model.pth --in isic --val imagenet --out dermofit-out --nc 8 --dv 2  --bs 1 > results/isic/panelC/rotation.txt
