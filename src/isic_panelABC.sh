...
python ood.py --m baseline --mcdo 20 --mc /raid/ferles/checkpoints/isic_classifiers/eb0CustomNoPreproc-best-model.pth --in isic --val imagenet --out places --nc 8 --dv 2  > results/isic/panelA/baseline_mcdo.txt
...
#python ood.py --m rotation --mc /raid/ferles/checkpoints/isic_classifiers/rot_isic-best-model.pth --in isic --val imagenet --out places --nc 8 --dv 0  --bs 1 > results/isic/panelA/rotation.txt
...
python ood.py --m baseline --mcdo 20 --mc /raid/ferles/checkpoints/isic_classifiers/eb0CustomNoPreproc-best-model.pth --in isic --val imagenet --out dermofit-in --nc 8 --dv 2  > results/isic/panelB/baseline_mcdo.txt
...
#python ood.py --m rotation --mc /raid/ferles/checkpoints/isic_classifiers/rot_isic-best-model.pth --in isic --val imagenet --out dermofit-in --nc 8 --dv 0  --bs 1 > results/isic/panelB/rotation.txt
...
python ood.py --m baseline --mcdo 20 --mc /raid/ferles/checkpoints/isic_classifiers/eb0CustomNoPreproc-best-model.pth --in isic --val imagenet --out dermofit-out --nc 8 --dv 2  > results/isic/panelC/baseline_mcdo.txt
...
#python ood.py --m rotation --mc /raid/ferles/checkpoints/isic_classifiers/rot_isic-best-model.pth --in isic --val imagenet --out dermofit-out --nc 8 --dv 0  --bs 1 > results/isic/panelC/rotation.txt
