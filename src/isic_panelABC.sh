...
python ood.py --m odin --mc /raid/ferles/checkpoints/isic_classifiers/eb0CustomNoPreproc-best-model.pth --out isic --val imagenet --out dermofit-out --nc 8 --dv 2  > results/isic/panelC/odin.txt
python ood.py --m mahalanobis --mc /raid/ferles/checkpoints/isic_classifiers/eb0CustomNoPreproc-best-model.pth --out isic --val imagenet --out dermofit-out --nc 8 --dv 2  --bs 20  > results/isic/panelC/mahalanobis.txt
python ood.py --m rotation --mc /raid/ferles/checkpoints/isic_classifiers/rot_isic-best-model.pth --out isic --val imagenet --out dermofit-out --nc 8 --dv 2  --bs 1 > results/isic/panelC/rotation.txt
python ood.py --m generalizedodin --mc /raid/ferles/checkpoints/isic_classifiers/GenOdinISICeb0-best-model.pth --out isic --val imagenet --out dermofit-out --nc 8 --dv 2  > results/isic/panelC/generalizedodin.txt
