...
python ood_triplets.py --m mahalanobis --mc /home/ferles/checkpoints/eb0/cifar10/low_dropout_eb0Cifar10.pth --in cifar10 --val cifar100 --bs --dv 0 --nc 10 > results/triplets/mahalanobis_low_dropout_cifar100.sh 
...
python ood_triplets.py --m mahalanobis --mc /home/ferles/checkpoints/eb0/cifar10/low_dropout_eb0Cifar10.pth --in cifar10 --val svhn --bs --dv 0 --nc 10 > results/triplets/mahalanobis_low_dropout_svhn.sh
...
python ood_triplets.py --m mahalanobis --mc /home/ferles/checkpoints/eb0/cifar10/low_dropout_eb0Cifar10.pth --in cifar10 --val stl --bs --dv 0 --nc 10 > results/triplets/mahalanobis_low_dropout_stl.sh
...
python ood_triplets.py --m mahalanobis --mc /home/ferles/checkpoints/eb0/cifar10/low_dropout_eb0Cifar10.pth --in cifar10 --val tinyimagenet --bs --dv 0 --nc 10 > results/triplets/mahalanobis_low_dropout_tinyimagenet.sh