...
if __name__ == '__main__':
    ...
    if ood_method == 'baseline':
        ...
        method_loaders = loaders[1:]
        _odin(model, loaders, device, ind_dataset=args.in_distribution_dataset, val_dataset=args.val_dataset, ood_dataset=args.out_distribution_dataset, exclude_class=args.exclude_class)
