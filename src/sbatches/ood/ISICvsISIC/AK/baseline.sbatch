...
python ood.py --ood_method baseline \
              ...
              --model_checkpoint checkpoints/isic_classifiers/custom_exclude_AK_step_lr_cutout_eb0-best-balanced-accuracy-model_new.pth \
              --exclude_class AK > results/txts/ISICvsISIC/AK/baseline_AK_new_bac.txt
