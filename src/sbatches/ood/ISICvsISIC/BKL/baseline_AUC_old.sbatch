...
python ood.py --ood_method baseline \
              ...
              --model_checkpoint checkpoints/isic_classifiers/custom_exclude_BKL_step_lr_cutout_eb0-best-auc-model_old.pth \
              --exclude_class BKL > results/txts/ISICvsISIC/BKL/baseline_BKL_old_auc.txt
