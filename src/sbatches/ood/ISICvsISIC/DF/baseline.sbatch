...
python ood.py --ood_method baseline \
              ...
              --model_checkpoint checkpoints/isic_classifiers/custom_exclude_DF_step_lr_cutout_eb0-best-balanced-accuracy-model_new.pth \
              --exclude_class DF > results/txts/ISICvsISIC/DF/baseline_DF_new_bac.txt
