...
python ood.py --ood_method baseline \
              ...
              --model_checkpoint checkpoints/isic_classifiers/custom_exclude_VASC_step_lr_cutout_eb0-best-auc-model_old.pth \
              --exclude_class VASC > results/txts/ISICvsISIC/VASC/baseline_VASC_old_auc.txt
