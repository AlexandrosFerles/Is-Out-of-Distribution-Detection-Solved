...
python ood.py --ood_method baseline \
              ...
              --model_checkpoint checkpoints/isic_classifiers/custom_exclude_AK_step_lr_cutout_eb0-best-auc-model_old.pth \
              --exclude_class AK > results/txts/ISICvsISIC/AK/baseline_AK_old_auc.txt
