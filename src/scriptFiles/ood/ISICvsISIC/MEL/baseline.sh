...
python ood.py --ood_method baseline \
              ...
              --model_checkpoint checkpoints/isic_classifiers/custom_exclude_MEL_step_lr_cutout_eb0-best-balanced-accuracy-model_new.pth \
              --exclude_class MEL > results/txts/ISICvsISIC/MEL/baseline_MEL_new_bac.txt
