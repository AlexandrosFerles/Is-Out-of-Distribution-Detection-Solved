...
python ood.py --ood_method baseline \
              ...
              --model_checkpoint checkpoints/isic_classifiers/custom_exclude_SCC_step_lr_cutout_eb0-best-balanced-accuracy-model_old.pth \
              --exclude_class SCC > results/txts/ISICvsISIC/SCC/baseline_SCC_old_bac.txt
